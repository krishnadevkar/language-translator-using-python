#language translator app by krishna devkar
#import modules
...
root.title('Language Translator By Krishna')
...
Input_text = Text(root,font = 'arial 14', height = 15, wrap = WORD, padx=5, pady=5, width = 60)
Input_text.place(x=30,y = 100)

Label(root,text ="Output", font = 'arial 13 bold', bg ='white smoke').place(x=780,y=60)

Output_text = Text(root,font = 'arial 12', height = 15, wrap = WORD, padx=5, pady= 5, width =60)
